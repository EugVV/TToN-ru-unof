...
- изменения имён и названий: Chalcedon — Халцедон (был Челседон), Garravia Sound — Гарравийский залив (было по-разному), Observant Speck — Внимательная Крупинка (была Служительница Крупинка), Reconciler of Truth — Согласователь Истины (был Синхронизатор Истины), Tranquility — Безмятежность (была Транквилити);
